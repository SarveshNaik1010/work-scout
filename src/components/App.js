...
function App() {
  ...
  return (
    <>
      <h1 className="m-4 text-4xl text-center uppercase font-bold ph:text-2xl"> <span className="text-[#007bff]">Work</span> <span className="text-stone-800">Scout</span></h1>
